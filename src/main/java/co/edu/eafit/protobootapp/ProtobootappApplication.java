...
//Se lanza y se ejecuta con http://localhost:8000 o la URL específica al proveedor cloud
...
public class ProtobootappApplication {
    ...
    //Se ejecuta con http://localhost:8000/
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido! Esta aplicación ayuda a elevar números a sus potencias y a entender AWS mucho mejor.");
    }    

    //Se ejecuta con http://localhost:8000/hola o http://localhost:8000/hola?nombre=John
    @GetMapping("/hola")
    public String hola(@RequestParam(value = "nombre", defaultValue = "Mundo") String nombre) {
        return String.format("Hola %s!", nombre);
    }
    
    //Se ejecuta con http://localhost:8000/cuadrado o http://localhost:8000/cuadrado?numero=5
    @GetMapping("/cuadrado")
    ...
    //Se ejecuta con http://localhost:8000/cubo o http://localhost:8000/cubo?numero=5
    @GetMapping("/cubo")
